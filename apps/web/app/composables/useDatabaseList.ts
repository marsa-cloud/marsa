...
export function useDatabaseList(environmentUuid?: string) {
  return useKeysetList<DatabaseSummary, ViewDatabaseIndexQueryKey>(
    '/v1/databases',
    raw => zViewDatabaseIndexResponse.parse(raw),
    20,
